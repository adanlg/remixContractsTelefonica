...
contract Pay is Ownable {
    ...
    uint256 public cost = 200000000000000; // WEIs 244000000000000000
    Base public base;
    ...
    function tryAgain(address _player, uint256 _level) public {
        require(base.existPlayer(_player), "No eres un jugador");
        require(players[_player][_level] != 0, "No has pagado para desplegar el nivel");
        require(contracts[_player][_level] == address(0), "Contrato ya desplegado");
        emit Payed(_player, _level);
    }
